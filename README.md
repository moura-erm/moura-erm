...
- 🔭 Working on building **web platforms, automations, and data integration**.
- 🌱 Focusing on deepening my practical knowledge in **Pipelines, Serverless architecture, and the Azure ecosystem** (Functions, Key Vault).
- ⚙️ **Daily tools:** VS Code + GitHub Copilot.
...
#### 📚 On my nightstand (and in my headphones)
Lately, I've been dedicating my time to various books and sounds:
